...
var getUserIdFromRequest = function getUserIdFromRequest(req) {
...
var createProject = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var userId, lastProject, currentTime, twelveHoursAgo, newProject;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          lastProject = _context.sent;
          currentTime = new Date();
          twelveHoursAgo = new Date(currentTime.getTime() - 12 * 60 * 60 * 1000);
          ...
          return _context.abrupt("return", res.status(403).json({
            ...
            waitTime: lastProject.createdAt.getTime() + 12 * 60 * 60 * 1000 - currentTime.getTime()
          }));
        case 9:
          newProject = new Project(_objectSpread(_objectSpread({}, req.body), {}, {
            userId: userId
          }));
          _context.next = 12;
  ...
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          userId = getUserIdFromRequest(req); // No authorization check, proceed to fetch projects
          _context2.next = 4;
          return Project.find({
            userId: userId
          });
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 10:
          ...
          console.error("Error fetching project:", _context3.t0);
          res.status(500).json({
